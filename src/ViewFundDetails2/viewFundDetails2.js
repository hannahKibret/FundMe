...
const ViewFundDetails2 = () => {
  ...
  const donateClicked = (image,title) => {
    navigate('/donate',{state:{token:location.state.token,firstName:location.state.firstName,id:location.state.id,title:title,image:image}})
  }
      ...
      <div>
        ...
        <div className='img-side-card'>
          ...
          <div className='card-img'>
            <img className='fund-img' src={values.image} alt="img"/>
          </div>
          <div className='card-container'>
            ...
            <button className='donate' onClick={() => donateClicked(values.image,values.title)}>Donate Now</button>
        ...
        <div className='name-container'>
          ...
          <span className='name'>{values.recipient}</span><span className='name'> is organizing this fundraiser</span>
        </div>
        <hr className='hr-1'/>
        <div className='descc'>
        ...
        
        {
            values.donations
            .map(donation =>
              <div key = {donation._id} className='donated-container'>
                <img className='user-icon' src='img/user.png'/>
                ...
                <p data-cy='amt-don'>Donated {donation.amount}birr</p>
                <hr/>
            </div>
            )}
      </div>
...
export default ViewFundDetails2;
